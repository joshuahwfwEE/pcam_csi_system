...
set_property MARK_DEBUG true [get_nets pcam_csi_sys_i/mipi_csi2_tx_subsyst_0/inst/mipi_dphy_0_init_done]
...
connect_debug_port csi_tx_hs_ila/clk [get_nets [list pcam_csi_sys_i/clk_wiz_0_clk_out4]]
...
set_property port_width 1 [get_debug_ports csi_tx_hs_ila/probe3]
connect_debug_port csi_tx_hs_ila/probe3 [get_nets [list pcam_csi_sys_i/mipi_csi2_tx_subsyst_0/inst/mipi_dphy_0_init_done]]
create_debug_port csi_tx_hs_ila probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports csi_tx_hs_ila/probe4]
set_property port_width 1 [get_debug_ports csi_tx_hs_ila/probe4]
connect_debug_port csi_tx_hs_ila/probe4 [get_nets [list pcam_csi_sys_i/mipi_csi2_tx_subsyst_0/inst/txbyteclkhs]]
