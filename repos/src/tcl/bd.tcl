...
proc create_hier_cell_reset_sys { parentCell nameHier } {
  ...
  # Create instance: reset_pixel_clk, and set properties
  set reset_pixel_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 reset_pixel_clk ]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins interconnect_aresetn] [get_bd_pins reset_100M/interconnect_aresetn]
  connect_bd_net -net ARESETN_2 [get_bd_pins interconnect_aresetn1] [get_bd_pins reset_pixel_clk/interconnect_aresetn]
  connect_bd_net -net Net [get_bd_pins ext_reset_in] [get_bd_pins reset_100M/ext_reset_in] [get_bd_pins reset_200M/ext_reset_in] [get_bd_pins reset_pixel_clk/ext_reset_in]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins peripheral_aresetn] [get_bd_pins reset_100M/peripheral_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins slowest_sync_clk1] [get_bd_pins reset_pixel_clk/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins dcm_locked] [get_bd_pins reset_pixel_clk/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins peripheral_aresetn1] [get_bd_pins reset_pixel_clk/peripheral_aresetn]
  connect_bd_net -net reset_200M_interconnect_aresetn [get_bd_pins interconnect_aresetn2] [get_bd_pins reset_200M/interconnect_aresetn]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXI_S2MM] [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_net -net ARESETN_2 [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins reset_sys/interconnect_aresetn1]
  ...
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tuser [get_bd_pins axi_vdma_0/m_axis_mm2s_tuser] [get_bd_pins csitx_setting/tuser]
  connect_bd_net -net axi_vdma_0_s_axis_s2mm_tready [get_bd_pins axi_vdma_0/s_axis_s2mm_tready] [get_bd_pins axis_subset_converter_0/m_axis_tready] [get_bd_pins hdmi_rx_detect_0/s_axis_tready]
  ...
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axi_vdma_0/s_axis_s2mm_tlast] [get_bd_pins axis_subset_converter_0/m_axis_tlast] [get_bd_pins hdmi_rx_detect_0/s_axis_tlast]
  connect_bd_net -net axis_subset_converter_0_m_axis_tuser [get_bd_pins axi_vdma_0/s_axis_s2mm_tuser] [get_bd_pins axis_subset_converter_0/m_axis_tuser] [get_bd_pins hdmi_rx_detect_0/s_axis_tuser]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axi_vdma_0/s_axis_s2mm_tvalid] [get_bd_pins axis_subset_converter_0/m_axis_tvalid] [get_bd_pins hdmi_rx_detect_0/s_axis_tvalid]
  connect_bd_net -net bg0_pin6_nc_0_1 [get_bd_ports bg0_pin6_nc_0] [get_bd_pins mipi_csi2_rx_subsyst_0/bg0_pin6_nc]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins clk_wiz_pixel/clk_out1] [get_bd_pins hdmi_rx_detect_0/ACLK] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_aclk] [get_bd_pins reset_sys/slowest_sync_clk1] [get_bd_pins system_ila_0/clk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk]
  ...
  connect_bd_net -net o_col_cnt [get_bd_pins hdmi_rx_detect_0/o_col_cnt] [get_bd_pins system_ila_0/probe0]
  ...
  connect_bd_net -net o_row_cnt [get_bd_pins hdmi_rx_detect_0/o_row_cnt] [get_bd_pins system_ila_0/probe1]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins hdmi_rx_detect_0/ARESETN] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_aresetn] [get_bd_pins reset_sys/peripheral_aresetn1] [get_bd_pins system_ila_0/resetn] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins csitx_setting/dout] [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_tuser]
